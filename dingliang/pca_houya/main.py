...
if __name__ == "__main__":
    inp = r"C:\yuechen\code\wuyahe\1.code\2.data-rescale\screenshot\houya-pca\img"
    outp = r"C:\yuechen\code\wuyahe\1.code\2.data-rescale\screenshot\houya-pca\pca"
